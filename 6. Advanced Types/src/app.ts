...
const e1: ElevatedEmployees = {
    ...
    startDate: new Date().toLocaleDateString('hn-HN', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' }).toUpperCase()
};
...
moveAnimal({ type: 'horse', runningSpeed: 24 });

// Type Casting
// const userInput = document.getElementById('user-input') as HTMLInputElement;
const userInput = <HTMLInputElement>document.getElementById('user-input')!;

userInput.value = 'Hola Mundo'
